...
public class CustomGallery extends BaseActivity implements ListView.OnScrollListener, GridView.OnItemClickListener {
	boolean mBusy = false;
	...
	private void updateUI() {
		...
		gadapter = new GalleyAdapter(CustomGallery.this, R.layout.cell_gallery_row, imagebucketlist);
