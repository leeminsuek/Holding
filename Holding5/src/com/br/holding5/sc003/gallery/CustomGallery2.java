...
import com.br.holding5.util.RecycleUtils;
...
public class CustomGallery2 extends Activity implements ListView.OnScrollListener, GridView.OnItemClickListener {
	boolean mBusy = false;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.image_list_view2);
		myapp = (Holding5)getApplicationContext();
		...
		galleylist.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					...
					mListAdapter = new ImageAdapter(CustomGallery2.this, R.layout.image_cell,mThumbImageInfoList);
		...
		btnSelectOk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(delmap.size() > 0){
					...
					ShowDialog(CustomGallery2.this, null, "이미지를 선택하지 않으셨습니다. 종료하시겠습니까?");
				}
			}
		});
...
//		BrImageCacheManager.getInstance().resume();
	...
	private void updateUI() {
		...
		gadapter = new GalleyAdapter(CustomGallery2.this, R.layout.cell_gallery_row, imagebucketlist);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		if (curCheckState) {
			...
			if (delmap.size() < resultsize) {
				...
				Toast.makeText(CustomGallery2.this, "더이상 선택이 불가능 합니다.", Toast.LENGTH_SHORT).show();
			}
		}
		selectcount.setText(String.valueOf(delmap.size()));
	}
...
//			convertView.setLayoutParams(ss);
	...
	private class DoFindImageList extends AsyncTask<String, Integer, Long> {
		...
		protected void onPreExecute() {
			mLoagindDialog = ProgressDialog.show(CustomGallery2.this, null,"이미지를 불러오는 중입니다.", true, true);
			super.onPreExecute();
		}
