...
public class SC004_S11117 extends BaseActivity{
	...
	private Button mBoardContentAddBtn;
...
//	private boolean mModify;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setContentView(R.layout.sc004_s11117);
			...
			mBoardContentAddBtn = (Button) findViewById(R.id.board_content_add_btn);
			...
			mBoardContentAddBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(mBoardContentEdit.getText().toString().equals("")) {
						BrUtilManager.getInstance().showToast(SC004_S11117.this, "내용을 입력해 주세요.");
					}
					else {
			...
			mPictureAddBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(MAX_SELECT_COUNT - mSelectImgCount <= 0) {
						...
						Intent intent = new Intent(SC004_S11117.this,CustomGallery.class);
		...
		try {
			AsyncTask<Void, Void, String> loadImage = new AsyncTask<Void, Void, String>() {
				...
				protected String doInBackground(Void... params) {
					...
					boolean flag = BrImageUtilManager.getInstance().saveOutput(SC004_S11117.this,mVideoThumbnail,getImageUri(testfile.getAbsolutePath()));
